...
// if(test==1){
//   document.querySelector("#toRight").disabled=false;
//   document.querySelector("#toRight").click();
// }
// if(test==0){
//   document.querySelector("#goLeft").disabled=false;
//   document.querySelector("#goLeft").click();
// }
